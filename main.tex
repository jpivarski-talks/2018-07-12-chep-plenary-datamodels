...
\vspace{0.25 cm}
\begin{itemize}
\item High-energy physicists have been performing big data analytics (i.e.\ reducing large datasets to statistical inferences with computers) \textcolor{darkblue}{for 50~years.}
\item<2-> Web-scale companies have been doing it \textcolor{darkblue}{for 10~years.}
\end{itemize}
...
\vspace{0.25 cm}
Modern big data software has some good ideas; integrate those {\it ideas} into our stack.
\end{uncoverenv}
...
\vspace{1 cm}
\uncover<5->{\textcolor{red}{This is my opinion, but it begs the question of where to draw the line.}}
\end{frame}
...
\column{0.5\linewidth}
\mbox{\hspace{0.45 cm}\underline{What more we'd need}}
...
\vspace{0.5 cm}
\begin{center}
To understand what I mean by ``indexed analysis,''

consider analysis with less indexing than modern HEP.
\end{center}
\end{frame}
...
\vspace{1 cm}
\textcolor{red}{They must be identified by integers because histograms didn't have names back then.}
...
\item Pandas (2-D) and xarray ($n$-D) differ from Numpy in that they have many index types and perform operations that only have meaning in light of those indexes.
