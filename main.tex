...
\node[rectangle callout, draw, inner sep=5 pt, callout relative pointer={(-200:-1 cm)}, text width=0.44\linewidth] {\large Nested data are in these projects' scope, but as second-class citizens.};
\end{tikzpicture}}
